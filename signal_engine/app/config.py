...
class Settings:
    ...
    # Test baseline: 1 USDT margin at 100x leverage -> about 100 USDT position notional.
...
def validate_settings(settings: Settings) -> tuple[list[str], list[str]]:
    ...
    if settings.bootstrap_limit_15m < 3400:
        warnings.append(
            f"BOOTSTRAP_LIMIT_15M={settings.bootstrap_limit_15m} is below 3400; runtime will use 3400 for FINAL18 TIER EMA200 warmup"
        )
